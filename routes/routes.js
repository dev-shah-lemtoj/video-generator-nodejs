...
module.exports = function (route) {
    ...
    res.render('drag-drop', {
        icons,
        isOver: false, // or set dynamically
        isDragging: false,
        canvasSize: { width: "auto", height: 520 },
        components: [], // or some array of components
        dropIndicatorStyles: null, // or actual style values if needed
        title: 'Drag-Drop',
